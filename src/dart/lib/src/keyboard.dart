...
/// Minimal driver surface for adapters that must feed the canonical session.
///
/// [DndSession] implements this directly. UI wrappers such as Flutter can also
/// implement it while adding notifications around [apply], so keyboard input
/// still drives the exact same state machine as pointer/native drag events.
