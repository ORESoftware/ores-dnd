...
abstract final class Wire {
  ...
  static bool isMediaType(Object? v) =>
      v is String && v.length <= mediaTypeMax && _mediaType.hasMatch(v);
  static bool isMediaTypePattern(Object? v) =>
      v is String && v.length <= mediaTypeMax && _mediaTypePattern.hasMatch(v);
  static bool isTraceparent(Object? v) =>
      v is String && _traceparent.hasMatch(v);
  ...
  static String? optionalSafeId(Object? value, String label) =>
